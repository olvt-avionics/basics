...
int main()
{
	...
	std::ifstream inFile;
	// File location: "C:\\Users\\rshaf\\Documents\\Virginia Tech\\Fall 2019\\OLVT\\Avionics Code\\input_file.txt"
	chronostart = std::chrono::steady_clock::now();
	inFile.open("C:\\Users\\rshaf\\Documents\\Virginia Tech\\Fal 2019\\OLVT\\Avionics Code\\input_file.txt");
	if (!inFile) {
